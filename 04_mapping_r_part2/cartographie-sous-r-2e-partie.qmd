...
```{r}
#| label: check-data
stopifnot(file.exists("data/rasters/tza_pop_2022_constrained.tif"))
```
...
rainfall_rasters <- list.files(
  path = "data/rasters/", pattern = "chirps", full.names = TRUE
)
...
#| eval: false
writeRaster(
  pop_at_risk, "data/rasters/population_risk_2022.tif", overwrite = TRUE
)
```
