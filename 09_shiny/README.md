...
- `_lesson/09_rshiny_dashboard.qmd`: complete workshop lesson
- `_lesson/images/`: figures used by the lesson
...
Read the local [complete workshop lesson](_lesson/09_rshiny_dashboard.qmd), or use
